...
2. **Fetches listings** from Bienici and Trente Cinq Notaires (configurable filters for Bienici; Trente Cinq Notaires: page 1, locations only).
...
├── workflows/
│   └── recherche_appart_rennes.json   # Main workflow (Bienici + Trente Cinq Notaires + Sheet + Groq + Telegram)
├── .github/workflows/
